    ...
    <footer id="footer">
      ...
      <div class="container-fluid">
        <div class="copyright fs-sm-6">
          <strong>©2024 TechSource Managed Services</strong>.
        </div>
        <div class="credits fs-sm-6 pb-3">
          Created by <a href="https://atlantis.tech/"> Atlantis Tech</a>
        </div>
      </div>
    </footer>
